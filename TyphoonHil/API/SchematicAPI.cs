...
namespace TyphoonHil.API
{
    ...
    public class Size
    {
        ...
        public JArray JArray
        {
            get { return new JArray(Width, Height); }
            set { JArray = value; }
        }
    ...
    public class Dimension
    {
        ...
        public double Width { get; set; }
        public double? Height { get; set; }
        public JArray JArray => Height == null ? new JArray { Width } : new JArray { Width, Height }; //check if they should swap order
    ...
    public class TerminalPosition
    {
        ...
        public JArray JArray
        {
            get { return new JArray(First, Second); }
            set { JArray = value; }
        }
    }
    ...
    public class SchematicAPI : AbstractAPI
    {
        ...
        public JObject CreatePort(string name = null,
            ...
            Position position = null)
        {
            dimension = dimension == null ? new Dimension(1) : dimension;
            terminalPosition = terminalPosition == null ? new TerminalPosition("left", "auto") : terminalPosition;
            var parameters = new JObject
        {
            { "name", name },
            { "parent", parent },
            ...
            var parameters = new JObject
        {
            ...
            { "start", start },
            { "end", end },
            { "breakpoints", breakpoints == null ? null : new JArray { breakpoints.Select(bp => bp.JArray) } }
        };
        ...
        public JArray DetectHwSettings() // Consider creating new Model with hw configuration
        {
            try
            {
            ...
            List<string> additionalDefinitions = null)
        {
            var parameters = new JObject
            {
                ...
                { "additional_definitions", additionalDefinitions != null ? new JArray { additionalDefinitions } : null }
            };
