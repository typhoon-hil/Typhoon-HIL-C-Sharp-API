...
namespace TyphoonHilTests.API
{
    ...
    public class SchematicAPITests
    {
        ...
        {
            String[] lines1 = File.ReadAllLines(filePath1).Skip(5).ToArray(); ;
            String[] lines2 = File.ReadAllLines(filePath2).Skip(5).ToArray(); ;

            return lines1.SequenceEqual(lines2);
        }
